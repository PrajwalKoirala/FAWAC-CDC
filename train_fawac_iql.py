...
from fawac_configs import BC_DEFAULT_CONFIG, BCTrainConfig
from osrl.common.dataset import process_bc_dataset
from osrl.common.exp_util import auto_name, seed_all
from fawac import ReplayBuffer, FAWAC_IQL_kwargs, FAWAC_IQL_Trainer
...
def train(args: BCTrainConfig):
    ...
    if args.name is None:
        args.name = auto_name(default_cfg, cfg, args.prefix, args.suffix) + f"_{args.obj_method}" + f"_{args.task}"
    ...
    iql_trainer_kwargs = FAWAC_IQL_kwargs(args_dict)
    ...
    iql_trainer_kwargs["beta"] = args.beta

    iql_trainer_kwargs["lag_max"] = args.lag_max
    iql_trainer_kwargs["cost_planning_steps"] = args.cost_planning_steps
    iql_trainer_kwargs["obj_method"] = args.obj_method
    iql_trainer_kwargs["cost_limit"] = args.cost_limit


    # model & optimizer setup
    iql_trainer = FAWAC_IQL_Trainer(**iql_trainer_kwargs)
